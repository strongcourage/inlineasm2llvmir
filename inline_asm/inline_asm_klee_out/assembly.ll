...
entry:
  ...
  %1 = call i32 (...)* @klee_make_symbolic(i32* %arg1, i64 4, i8* getelementptr inbounds ([5 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !122
  %2 = load i32* %arg1, align 4, !dbg !124
  %3 = icmp sgt i32 %2, 0, !dbg !124
  %4 = load i32* %arg1, align 4, !dbg !125
  %5 = load i32* %arg2, align 4, !dbg !125
  br i1 %3, label %bb, label %bb1, !dbg !124

bb:                                               ; preds = %entry
  %6 = sub nsw i32 %4, %5, !dbg !125
  store i32 %6, i32* %add, align 4, !dbg !125
  br label %bb2, !dbg !125

bb1:                                              ; preds = %entry
  %asmtmp = call i32 asm "addl %ebx, %eax;", "={ax},{ax},{bx},~{dirflag},~{fpsr},~{flags}"(i32 %4, i32 %5) nounwind, !dbg !126
  store i32 %asmtmp, i32* %add, !dbg !126
...
entry:
  ...
  %x1 = bitcast i32* %x to i8*, !dbg !132
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %x1, i64 4, i8* %name) nounwind, !dbg !132
  %0 = load i32* %x, align 4, !dbg !133
  ret i32 %0, !dbg !133
}

define void @klee_overshift_check(i64 %bitWidth, i64 %shift) nounwind {
entry:
  %0 = icmp ult i64 %shift, %bitWidth, !dbg !134
  br i1 %0, label %return, label %bb, !dbg !134
...
entry:
  %x = alloca i32, align 4
  %0 = icmp slt i32 %start, %end, !dbg !138
  br i1 %0, label %bb1, label %bb, !dbg !138

bb:                                               ; preds = %entry
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) noreturn nounwind, !dbg !139
  unreachable, !dbg !139

bb1:                                              ; preds = %entry
  %1 = add nsw i32 %start, 1, !dbg !140
  %2 = icmp eq i32 %1, %end, !dbg !140
  br i1 %2, label %bb8, label %bb3, !dbg !140

bb3:                                              ; preds = %bb1
  %x4 = bitcast i32* %x to i8*, !dbg !141
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %x4, i64 4, i8* %name) nounwind, !dbg !141
  %3 = icmp eq i32 %start, 0, !dbg !142
  %4 = load i32* %x, align 4, !dbg !143
  br i1 %3, label %bb5, label %bb6, !dbg !142

bb5:                                              ; preds = %bb3
  %5 = icmp ult i32 %4, %end, !dbg !143
  %6 = zext i1 %5 to i64, !dbg !143
  call void @klee_assume(i64 %6) nounwind, !dbg !143
  br label %bb7, !dbg !143

bb6:                                              ; preds = %bb3
  %7 = icmp sge i32 %4, %start, !dbg !144
  %8 = zext i1 %7 to i64, !dbg !144
  call void @klee_assume(i64 %8) nounwind, !dbg !144
  %9 = load i32* %x, align 4, !dbg !145
  %10 = icmp slt i32 %9, %end, !dbg !145
  %11 = zext i1 %10 to i64, !dbg !145
  call void @klee_assume(i64 %11) nounwind, !dbg !145
  br label %bb7, !dbg !145

bb7:                                              ; preds = %bb6, %bb5
  %12 = load i32* %x, align 4, !dbg !146
...
entry:
  %0 = icmp eq i64 %len, 0, !dbg !148
  br i1 %0, label %bb2, label %bb, !dbg !148
...
bb:                                               ; preds = %bb, %entry
  ...
  %1 = load i8* %src.06, align 1, !dbg !149
  store i8 %1, i8* %dest.05, align 1, !dbg !149
  %indvar.next = add i64 %indvar, 1
  %exitcond1 = icmp eq i64 %indvar.next, %len
  br i1 %exitcond1, label %bb1.bb2_crit_edge, label %bb, !dbg !148
...
!1 = metadata !{i32 589865, metadata !"inline_asm_klee.c", metadata !"/home/dungnguyen/angelix/src/klee/examples/inline_asm/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"inline_asm_klee.c", metadata !"/home/dungnguyen/angelix/src/klee/examples/inline_asm/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ 
...
!124 = metadata !{i32 4, i32 0, metadata !123, null}
!125 = metadata !{i32 5, i32 0, metadata !123, null}
!126 = metadata !{i32 7, i32 0, metadata !123, null}
!127 = metadata !{i32 12, i32 0, metadata !123, null}
!128 = metadata !{i32 13, i32 0, metadata !129, null}
!129 = metadata !{i32 589835, metadata !6, i32 12, i32 0, metadata !7, i32 0} ; [ DW_TAG_lexical_block ]
!130 = metadata !{i32 14, i32 0, metadata !129, null}
!131 = metadata !{i32 15, i32 0, metadata !129, null}
!132 = metadata !{i32 15, i32 0, metadata !76, null}
!133 = metadata !{i32 16, i32 0, metadata !76, null}
!134 = metadata !{i32 21, i32 0, metadata !135, null}
!135 = metadata !{i32 589835, metadata !21, i32 20, i32 0, metadata !22, i32 0} ; [ DW_TAG_lexical_block ]
!136 = metadata !{i32 27, i32 0, metadata !135, null}
!137 = metadata !{i32 29, i32 0, metadata !135, null}
!138 = metadata !{i32 16, i32 0, metadata !83, null}
!139 = metadata !{i32 17, i32 0, metadata !83, null}
!140 = metadata !{i32 19, i32 0, metadata !83, null}
!141 = metadata !{i32 22, i32 0, metadata !83, null}
!142 = metadata !{i32 25, i32 0, metadata !83, null}
!143 = metadata !{i32 26, i32 0, metadata !83, null}
!144 = metadata !{i32 28, i32 0, metadata !83, null}
!145 = metadata !{i32 29, i32 0, metadata !83, null}
!146 = metadata !{i32 32, i32 0, metadata !83, null}
!147 = metadata !{i32 20, i32 0, metadata !83, null}
!148 = metadata !{i32 15, i32 0, metadata !108, null}
!149 = metadata !{i32 16, i32 0, metadata !108, null}
!150 = metadata !{i32 17, i32 0, metadata !108, null}
