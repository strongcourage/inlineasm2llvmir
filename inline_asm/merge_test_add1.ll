...
define i32 @main() #0 {
  ...
  %4 = call i64 @manh_dung(i64 %2, i64 %3, i64 %2, i64 %2, i64 %2, i64 %2)
  store i64 %4, i64* %ret, align 8
  ret i32 0
}
...
define private i64 @manh_dung1(i64, i64, i64, i64, i64, i64) {
entry:
  ret i64 0
}
